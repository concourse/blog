...
<figure class="kg-card kg-image-card"><img src="/assets/images/2020/06/build-and-publish-pipeline-3.png" class="kg-image" alt="build-and-push-pipeline" loading="lazy"    sizes="(min-width: 720px) 720px"></figure>
## Further Readings
